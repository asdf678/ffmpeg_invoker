...
namespace spleeter {
    namespace codec {
        ...
        static int decode(std::string path, int dst_rate, AVSampleFormat dst_sample_fmt,
                          const AVChannelLayout &dst_ch_layout, const std::int64_t start,
        ...
        FFmpegAudioDecoder::FFmpegAudioDecoder(int dst_sample_rate, AVSampleFormat dst_sample_fmt,
                                               const AVChannelLayout &dst_ch_layout,
                                               std::atomic_bool *cancel_token) : dst_sample_rate_(
                dst_sample_rate), dst_sample_fmt_(dst_sample_fmt), cancel_token_(cancel_token) {
        ...
        int FFmpegAudioDecoder::decode(std::string path, const std::int64_t start,
            ...
            return spleeter::codec::decode(path, dst_sample_rate_, dst_sample_fmt_, dst_ch_layout_,
                                           start, duration, *cancel_token_, result,
